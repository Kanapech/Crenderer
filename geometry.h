...
template <class t> struct Vec4 {
    t x, y, z, a;
    Vec4<t>() : x(t()), y(t()), z(t()), a(t()) { }
    Vec4<t>(t _x, t _y, t _z, t _a) : x(_x), y(_y), z(_z), a(_a) {}
    template <class u> Vec4<t>(const Vec4<u> &v);
    Vec4<t>(const Vec4<t> &v) : x(t()), y(t()), z(t()), a(t()) { *this = v; }
    ...
    Vec4<t> operator +(const Vec4<t> &v) const { return Vec4<t>(x+v.x, y+v.y, z+v.z, a+v.a); }
    Vec4<t> operator -(const Vec4<t> &v) const { return Vec4<t>(x-v.x, y-v.y, z-v.z, a-v.a); }
    Vec4<t> operator *(float f)          const { return Vec4<t>(x*f, y*f, z*f, a*f); }
    t       operator *(const Vec4<t> &v) const { return x*v.x + y*v.y + z*v.z + a*v.a; }
